...
describe('validateSubnetMask - Subnet Mask Validation', () => {
    ...
    describe('Dotted decimal notation validation', () => {
        ...
        test('rejects invalid subnet masks (non-consecutive bits)', () => {
            expect(validateSubnetMask('255.0.255.0')).toBe('Invalid subnet mask - must have consecutive 1s followed by 0s');
            expect(validateSubnetMask('255.255.0.255')).toBe('Invalid subnet mask - must have consecutive 1s followed by 0s');
            expect(validateSubnetMask('192.168.1.1')).toBe('Invalid subnet mask - must have consecutive 1s followed by 0s');
        });
